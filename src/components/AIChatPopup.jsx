...
export const AIChatPopup = ({ isOpen, onClose }) => {
  ...
  const speakText = (text) => {
    ...
    // 💡 THE CRITICAL FIX: Intercept raw web links and replace them in the audio channel
    // This stops the browser voice engine from choking on slash/dot syntax characters.
